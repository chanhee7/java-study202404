...
public class Main {
    ...
    // 사과 바구니 생성
        ...
        List<Apple> filteredApples3 = filterApples(appleBasket, new AppleWeightPredicate());
        ...
        List<Apple> apples3 = filterApples(appleBasket, apple ->
                apple.getColor() == RED && apple.getWeight() >= 100);
        System.out.println(apples3);


        System.out.println("=========== 노랑색이면서 가벼운 사과 ============");
        List<Apple> apples4 = filterApples(appleBasket, apple ->
                apple.getColor() == YELLOW && apple.getWeight() < 80);
        ...
        System.out.println("========= 숫자리스트에서 각 수자들의 제곱을 추출 ==========");
